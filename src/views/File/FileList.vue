  ...
  <div class="file-list">
    <header class="layout-header">
      <el-row type="flex" justify="space-between">
        <el-col :span="2">
          <el-button class="back" type="success" @click="goBack(-1);"
            >返回</el-button
          >
        </el-col>
        <el-col :span="2">
          ...
          >
            <el-button icon="ios-cloud-upload-outline" type="primary"
              >上传文件</el-button
            >
          </el-upload>
        </el-col>
    ...
    handleBeforeUpload(file) {
      ...
      if (!isImage) {
        return this.$message.error(
          `${
            file.name
          }文件格式错误，仅支持 ".png" ".jpg" ".jpeg" ".gif" 的图片文件`
        );
      }
    ...
    handleSubmit() {
      this.$refs.editForm.validate(valid => {
        if (valid) {
          ...
          this.asyncUpdateFile(body).then(() => this.getCurrPageData());
        }
      });
    },
    handleCancelDialog() {
